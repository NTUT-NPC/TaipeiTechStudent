...
public class Feedback2Activity extends BaseActivity implements
    ...
    static class FeedbackHandler extends Handler {
        private WeakReference<Feedback2Activity> activityRef;

        public FeedbackHandler(Feedback2Activity fragment) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case BaseRunnable.ERROR:
                    Feedback2Activity activity = activityRef.get();
                    if (activity != null) {
